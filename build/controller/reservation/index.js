...
var postReservation = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                _b.sent();
                room.blockedDayList.push(date_fns_1.format(new Date(checkIn), "yyyy-MM-dd"));
                room.blockedDayList.push(date_fns_1.format(new Date(checkOut), "yyyy-MM-dd"));
                room.blockedDayList = room.blockedDayList.filter(function (blockedDay) {
                    return date_fns_1.addDays(new Date(), -1) < new Date(blockedDay);
                });
                room.save();
            ...
            case 6:
                error_2 = _b.sent();
                return [2 /*return*/, res.status(500).send("예약에 실패했습니다.")];
