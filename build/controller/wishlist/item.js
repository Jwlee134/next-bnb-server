...
exports.deleteItem = exports.postItem = void 0;
var Wishlist_1 = __importDefault(require("../../model/Wishlist"));
var postItem = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, roomId, listId, wishlist, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, roomId = _a.roomId, listId = _a.listId;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
...
var deleteItem = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.query, roomId = _a.roomId, listId = _a.listId;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
