...
exports.postWishlist = exports.getWishlist = void 0;
...
var getWishlist = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                error_1 = _a.sent();
                return [2 /*return*/, res.status(500).send("위시리스트를 불러오는 데 실패했습니다.")];
            case 4: return [2 /*return*/];
        }
    });
}); };
exports.getWishlist = getWishlist;
var postWishlist = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var title, id, user, newWishlist, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                title = req.body.title, id = req.headers.user;
                _a.label = 1;
            case 1:
                _a.trys.push([1, 6, , 7]);
            ...
            case 2:
                ...
                return [4 /*yield*/, Wishlist_1.default.create({
                        title: title,
                        creator: id,
                    })];
            case 3:
                ...
                user.save();
                return [2 /*return*/, res.status(200).send(newWishlist)];
            case 4: return [2 /*return*/, res.status(404).send("로그인이 필요한 서비스입니다.")];
